...
const Register = ({ onRegister, navigateToLogin, navigateToRegisterAsFaculty, navigateToLanding }) => {
    ...
    <div className="register-container">
      <form onSubmit={handleSubmit} className="register-form">
        ...
        <div className="form-links">
          ...
          <button type="button" onClick={navigateToLanding} className="btn-link back-link">
            ← Back to Home
          </button>
        </div>
      </form>
