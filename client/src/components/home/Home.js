      ...
      <div className="content-section">
        ...
        <div id="menu-grid" className="menu-container fade-in-items">
          ...
          <div className="menu-item" onClick={navigateToLoans}>
            <div className="menu-item-image-container">
              <img src="https://hips.hearstapps.com/hmg-prod/images/how-to-get-a-personal-loan-1584033069.jpg" alt="Loans" className="menu-image" />
            </div>
            <div className="menu-item-content">
              <h3>Loans</h3>
          ...
          <div className="menu-item" onClick={navigateToFines}>
            <div className="menu-item-image-container">
              <img src="https://pacificlegal.org/wp-content/uploads/2018/09/excessive-fines.jpg" alt="Fines" className="menu-image" />
            </div>
            <div className="menu-item-content">
              <h3>Fines</h3>
          ...
          {isAdmin && (
            <div className="menu-item" onClick={navigateToAdminDashboard}>
              <div className="menu-item-image-container">
                <img src="https://media.istockphoto.com/id/1157569047/photo/red-arrow-moving-up-over-graph-paper-background.jpg?s=612x612&w=0&k=20&c=h_mHs726U_Osy2IapdLYJCfZHQoh8oxfG_lJoG4SwXI=" alt="Admin Dashboard" className="menu-image" />
              </div>
              <div className="menu-item-content">
